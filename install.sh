...
echo -e "--------------------------------------------------"
echo -e "Run ${GREEN}wugong init${NC} to initialize configuration and sync schedule."
echo -e "Run ${GREEN}wugong account add${NC} to setup your accounts."
echo -e "Run ${GREEN}wugong sync${NC} to manually sync emails."
echo -e "Run ${GREEN}wugong list${NC} to view your emails."
echo -e "Run ${GREEN}wugong send${NC} to send emails."
echo -e "Run ${GREEN}wugong upgrade${NC} to update."
